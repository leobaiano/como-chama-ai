 ...
 *  Save like data
 */
add_action( 'wp_ajax_nopriv_luxe-post-like', 'luxe_post_like' );
add_action( 'wp_ajax_luxe-post-like', 'luxe_post_like' );
function luxe_post_like() {
	$nonce = $_POST['nonce'];
    if ( ! wp_verify_nonce( $nonce, 'ajax-nonce' ) )
        die ( 'Nope!' );
	
	if ( isset( $_POST['luxe_post_like'] ) ) {
...
function getPostLikeLink( $post_id ) {
	...
	$output = '<span class="luxe-post-like">';
...
function getPostLikes( $post_id ) {
	...
	$output = '<span class="count">'.$likes.'</span>';
	return $output;
}
...
function show_user_likes( $user ) { ?>        
    <table class="form-table">
        <tr>
			<th><label for="user_likes"><?php _e( 'You Like:', 'themeluxe' ); ?></label></th>
			<td>
